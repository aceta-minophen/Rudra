...
class _VideoStreamState extends State<VideoStream> {
  final WebSocket _socket = WebSocket("ws://10.5.32.107:8000");
...
class _RemoteControlState extends State<RemoteControl>{
  ...
  final WebSocket _socket = WebSocket("ws://172.20.10.5:8000");
  bool _isConnected = false;
  void connect(BuildContext context) async {
    _socket.connect();
    setState(() {
  ...
  Future<void> writeData() async{
    ...
    DatabaseReference ref = FirebaseDatabase.instance.ref().child('joystick');
